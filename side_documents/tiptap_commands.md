...
#### [](#chain-inside-custom-commands)Chain inside custom commands
...
### [](#dry-run-commands)Dry run commands
...
For some of your own commands, you probably want to work with the raw [transaction](/docs/editor/core-concepts/introduction). To make them work with `.can()` you should check if the transaction should be dispatched. Here is how you can create a simple `.insertText()` command:
...
Insert a node or an HTML string at a specific position.

`setContent()`

Replace the whole document with new content.

### [](#nodes-and-marks)Nodes & Marks
...
Resets some node or mark attributes to the default value.
...
## [](#write-your-own-commands)Write your own commands

All extensions can add additional commands (and most do), check out the specific [documentation for the provided nodes](/docs/editor/extensions/nodes), [marks](/docs/editor/extensions/marks), and [functionality](/docs/editor/extensions/functionality) to learn more about those. And of course, you can [add your custom extensions](/docs/editor/extensions/custom-extensions) with custom commands as well. But how do you write those commands? There’s a little bit to learn about that.